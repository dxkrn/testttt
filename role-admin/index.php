                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="manajemenguru-admin.html" class='sidebar-link'>
                                <i class="bi bi-person-badge-fill"></i>
                                <span>Manajemen Guru</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="manajemenwalkes-admin.html" class='sidebar-link'>
                                <i class="bi bi-person-workspace"></i>
                                <span>Manajemen Wali Kelas</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="manajemensiswa-admin.html" class='sidebar-link'>
                            ...
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3 name">
                                        ...
                                        <h6 class="text-muted mb-0">@ad001</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
